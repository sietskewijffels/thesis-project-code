...
mixed is_detected_dummy historyad windowad history window run_order sequenceid id fp || participant:
...
//dit is niet goed volgens mij
mixed f1 historyad window windowad history || participant:
stop
